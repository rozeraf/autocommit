...
def show_confirmation(commit_msg: str, description: str | None, skip_confirm: bool = False) -> bool | None:
...
def _show_stats_and_warnings(msg_words: int, desc_words: int, total_chars: int, commit_msg: str):
