...
class CommitParser:
    ...
    def _validate_commit(self, subject: str, description: Optional[str]) -> Tuple[bool, list[str]]:
        ...
        if len(subject) > self.max_subject_length:
            warnings.append(f"Subject line is too long ({len(subject)} chars, max {self.max_subject_length})")
            is_valid = False
